...
from Frontend.Galeria import GaleriaCartas
from Frontend.Inventario import GaleriaCartasInventario
from Frontend.Ajustes import AjustesWidget
...
class MainWindow(QWidget):
    def __init__(self, usuario):
        ...
        for btn in [self.btn_agregar, self.btn_eliminar]:
        ...
        self.paginas.addWidget(QLabel("Buscar cartas aquí"))           # índice 1
    ...
    def cambiar_cuenta(self):
        ...
        self.ventana_login = Login.LoginWindow()
    ...
    def agregar_cartas(self):
        ...
        for carta in cartas_seleccionadas:
            try:
                cursor.execute(
                    "INSERT INTO usuario_carta (usuario_nombre, carta_id, nombre_pokemon) VALUES (?, ?, ?)",
                    (self.usuario, carta["id_api"], carta["nombre"])
                )
                exitos += 1
